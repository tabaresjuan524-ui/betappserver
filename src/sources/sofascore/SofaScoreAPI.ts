        ...
        for (let sportIndex = 0; sportIndex < sportsWithLiveEvents.length; sportIndex++) {
            ...
            try {
                ...
                await page.goto(sport.url, {
                    waitUntil: 'networkidle2', // Wait until most network activity has ceased
                ...
                for (const eventInfo of eventUrls) {
                    ...
                    try {
                        ...
                        // Add another small random delay before fetching event details
                        const eventDelay = Math.random() * 1500 + 500; // 0.5-2 seconds
